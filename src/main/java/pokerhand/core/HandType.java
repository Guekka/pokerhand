...
public enum HandType {
     ...
     * Three of a kind, trips or a set is a hand that contains three cards of one rank and two cards of two other ranks
     * (the kickers),
     * such as 9♣ 9♠ 9♦ 7♠ 3♣ ("three of a kind, nines" or "set of nines").
     ...
     * Four of a kind, quads or quads is a hand that contains four cards of one rank and one card of another rank
     * (the kicker),
     * such as 2♣ 2♠ 2♦ 2♥ 3♣ ("four of a kind, twos" or "quads of twos").
